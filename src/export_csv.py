...
# This script obtains a single artifact (AreaTree) from the server and exports its area
# data to a CSV file.

from flclient.flclient import default_prefix_string, R, SEGM
from config import fl

# Replace with the URI of the artifact you want to export.
# Use list_artifacts.py to get the list of all AreaTree URIs.
artUri = R["art1"]  
